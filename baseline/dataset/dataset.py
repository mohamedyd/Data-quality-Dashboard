...
import yaml
import argparse
from baseline.setup.detectors.detect_method import DATA_PATH as DATA_DIR
...
class Configuration:
    ...
    def load_config(dataset_name):
        ...
        Configuration class.
        """
        path = os.path.join(DATA_DIR, dataset_name, "parameters.yaml")
...
class Dataset:
    ...
    def __init__(self, parameters):
        ...
        if os.path.exists(os.path.join(self.directory, "clean.csv")):
