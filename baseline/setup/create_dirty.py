...
if __name__ == "__main__":
    ...
    # Get the data path
    DATASET_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../..", "experiments", "data", "housing"))
    ...
    dirty_df = inject_errors(clean_df=df_clean, error_types=method, params=[0.5, 5], muted_columns=['MEDV'],
