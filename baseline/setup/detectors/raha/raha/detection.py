...
class Detection:
    ...
    def __init__(self, labeling_budget=5):
        """
        The constructor.
        """
        ...
        params = json.dumps({'LABELING_BUDGET': self.LABELING_BUDGET,
                             'CLUSTERING_BASED_SAMPLING': self.CLUSTERING_BASED_SAMPLING,
                             'STRATEGY_FILTERING': self.STRATEGY_FILTERING,
                             'CLASSIFICATION_MODEL': self.CLASSIFICATION_MODEL,
                             'LABEL_PROPAGATION_METHOD': self.LABEL_PROPAGATION_METHOD,
                             'ERROR_DETECTION_ALGORITHMS': self.ERROR_DETECTION_ALGORITHMS})
        log_param('Raha', params)
