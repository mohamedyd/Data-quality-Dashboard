...
def outlierdetector(dirtydf, detect_method, detections_path):
    ...
    def SD(x, nstd=3.0):
        params = json.dumps({'nstd': nstd})
        log_param('Outlier_detection_SD', params)
    ...
    def IQR(x, k=1.5):
        ...
        log_param('Outlier_detection_IQR', params)
    ...
    def IF(x, contamination=0.01):
        params = json.dumps({'contamination': contamination})
        log_param('Outlier_detection_IF', params)
